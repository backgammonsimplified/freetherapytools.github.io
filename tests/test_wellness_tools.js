...
const records = [
  ...
  ["urge-surfing", { urge: "do something", trigger: "a cue", body: "tightness", thoughts: "a story", observe: "notice", noticed: "movement", changed: "shifted", helped: "feet", acted: "no", nextTime: "pause", nextAction: "call support", intensity: "82", afterIntensity: "61", checkpoints: [], timer: { duration: 180, remaining: 97, running: false } }],
];
...
for (const token of ["Start", "Pause", "Reset", "running: false", "getReadableSummary"]) assert.match(quick, new RegExp(token));
