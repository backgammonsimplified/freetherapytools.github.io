...
const record = progress.makeRecord({ toolId: "values", toolTitle: "Values", route: "/tool-finder/values/", schemaVersion: 1 }, legacyState, new Date("2026-08-23T12:00:00Z"));
...
const historyRecord = progress.makeRecord({ toolId: "values", toolTitle: "Values", route: "/tool-finder/values/", schemaVersion: 1 }, historyState, new Date("2026-08-23T12:05:00Z"));
