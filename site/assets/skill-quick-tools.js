(function (global) {
  ...
  function initBoxBreathing(root) {
    ...
    function updateStatus() {
      ...
      root.querySelectorAll("[data-breath-side]").forEach((label) => {
        const active = snapshot.running && label.dataset.breathSide === snapshot.phase;
    ...
    function render() {
      ...
      root.innerHTML = pageShell("Box Breathing", "Use a configurable four-phase breathing timer. Either hold can be set to 0.", `<div class="box-breathing-tool"><div class="box-breathing-stage" aria-live="polite"><div class="box-breathing-diagram" aria-label="Box breathing phase path"><div class="box-breathing-side box-breathing-side--hold-in" data-breath-side="holdIn"><strong>Hold</strong><small>after inhale</small></div><div class="box-breathing-side box-breathing-side--inhale" data-breath-side="inhale"><strong>Inhale</strong></div><div class="box-breathing-visual"><div class="box-breathing-circle" data-breath-circle style="--breath-progress:0"><span data-breath-phase>Ready</span><small data-breath-remaining>${state.cycles} completed cycles</small></div></div><div class="box-breathing-side box-breathing-side--exhale" data-breath-side="exhale"><strong>Exhale</strong></div><div class="box-breathing-side box-breathing-side--hold-out" data-breath-side="holdOut"><strong>Hold</strong><small>after exhale</small></div></div></div><div class="box-breathing-settings">${controls}<aside class="skill-app-note box-breathing-safety">Please consult your doctor or health care practitioner before holding your breath if you have concerns about whether breath-hold exercises are appropriate for you. Everyone has different breathing needs. Be mindful of what feels safe and works for you.</aside></div><div class="skill-app-actions box-breathing-actions"><button type="button" data-breath-start>Start</button><button type="button" class="secondary" data-breath-pause disabled>Pause</button><button type="button" class="secondary" data-breath-reset>Reset</button></div></div><p class="skill-app-note">The source curriculum names Box Breathing but does not prescribe timings. Four seconds per phase is a configurable starting setup, not a required pace.</p>`, learnLinks([["Goal Setting strengths", "/learn/goal-setting/goal-setting-guidelines.html#strengths"]]));
