...
Missing Links, and The Dime Game now use the shared `ConstrainedTreeEngine` in
...
- `/skill-finder/dime-game/` uses the exact source name, **The Dime Game**, and
  the ten factors from Interpersonal Effectiveness Worksheet 6. Asking counts
  Yes answers, saying No counts No answers, and the source's ten-dime response
  scale is shown without new scoring logic.
